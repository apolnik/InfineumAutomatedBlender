...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        procedure_tree = new QTreeView(centralwidget);
        procedure_tree->setObjectName(QString::fromUtf8("procedure_tree"));
        procedure_tree->setGeometry(QRect(500, 151, 391, 261));
        ...
        beakers_tabwid->setCurrentIndex(0);
        subtabs1->setCurrentIndex(2);
